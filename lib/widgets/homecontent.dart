      ...
      body: Column(
        children: [
          Container(
            ...
            height: 300,
            child: Image.asset('assets/images/HomePageTopNav.png', fit: BoxFit.cover),
          ),
          SizedBox(height: 10),
          Expanded(
            child: Padding(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Monthly Period", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                                SizedBox(height: 4),
                                Text("Next Period : ${DateFormat('d MMM yyyy').format(_lastPeriodDate!.add(Duration(days: 28)))}",
                                  style: TextStyle(color: Colors.white70)),
                                SizedBox(height: 2),
                                Text("${_daysUntilNextPeriod()} days until next period", style: TextStyle(color: Colors.white70)),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(DateFormat('dd').format(_lastPeriodDate!.add(Duration(days: 28))),
                                    style: TextStyle(fontSize: 18, color: Colors.red, fontWeight: FontWeight.bold)),
                                Text(DateFormat('MMM').format(_lastPeriodDate!.add(Duration(days: 28))),
                          ...
                          children: [
                            ...
                            Stack(
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    Icon(FontAwesomeIcons.capsules, color: Colors.white, size: 24),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (nextAppointment != null) ...[
                                ...
                                SizedBox(height: 2),
                                Text(DateFormat('EEE d MMM yyyy, h:mm a').format(nextAppointment!.startTime),
                                  style: TextStyle(color: Colors.white70)),
                              ] else
                  ...
                  Row(
                    ...
                    children: [
                      _buildIconButton(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => DoctorAppointmentPage())),
                      ),
                      SizedBox(width: 20),
                      _buildIconButton(
                        icon: FontAwesomeIcons.capsules,
                        color: const Color.fromARGB(255, 57, 202, 91),
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => TakeMedicinePage())),
                      ),
                      SizedBox(width: 20),
                      _buildIconButton(
                        icon: Icons.water_drop,
                        color: Color.fromARGB(255, 255, 127, 159),
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => Addmonthlyperiod())),
                      ),
                    ],
                  ),
                  SizedBox(height: 20)
